      ...
      <div class="content-wrapper  pt-3" style="min-height: 567.854px;">
        ...
        <section class="content  text-dark">
          <div class="container-fluid">
            <?php if(($_settings->userdata('status') == 0 || $_settings->userdata('status') == '') && $page != 'user/manage_profile'): ?>
              <div class="alert alert-danger rounded-0">
                <p class="mb-0">Your Account is not yet validated. Please give us time to approve your account and please make sure that you have updated your <b><a href="./?page=user/manage_profile">Personal Information</a></b> to help us validate your account. Thank you!</p>
              </div>
            <?php endif; ?>
            <?php 
