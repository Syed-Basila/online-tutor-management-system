    ...
    <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
        <div class="card card-outline card-primary rounded-0 shadow">
            ...
            <div class="card-footer py-1 text-center">
                ...
                <a class="btn btn-light btn-flat bg-gradient-light border btn-sm" href="./?page=tutors/view_tutor&id=<?= isset($id) ? $id : '' ?>"><i class="fa fa-times"></i> Cancel</a>
            </div>
        </div>
    </div>
</div>
        ...
        $('#manage-profile-form').submit(function(e){
            ...
            $.ajax({
                ...
                success:function(resp){
                    ...
                    location.replace('./?page=tutors/view_tutor&id='+resp.uid);
                    }else if(!!resp.msg){
                        el.html(resp.msg)
                        el.show('slow')
                        _this.prepend(el)
