        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT i.*, CONCAT(t.lastname,', ',t.firstname , COALESCE(concat(' ', t.middlename), '')) as `tutor` from `inquiry_list` i  inner join tutor_list t on i.tutor_id = t.id order by i.`status` asc, abs(unix_timestamp(i.date_created)) desc ");
